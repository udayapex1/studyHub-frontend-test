...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await login(formData.password, formData.email);
      if (res) {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 font-['Inter',sans-serif] flex items-center justify-center p-4">
        ...
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
